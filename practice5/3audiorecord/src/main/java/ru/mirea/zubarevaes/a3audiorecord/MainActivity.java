// приложение для работы с диктофоном, позволяющее
// записывать аудио и его воспроизводить
package ru.mirea.zubarevaes.a3audiorecord;
...
import ru.mirea.zubarevaes.a3audiorecord.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    //В методе «startRecording» создается и инициализируется экземпляр
    //«MediaRecorder». В качестве источника данных выбирается микрофон (MIC),
    //выходной формат устанавливается «3GPP» (файлы *.3gp), ориентированный на
    //мобильные устройства. Значение кодека установлено «AMR_NB» – аудиоформат с
    //частотой дискретизации 8 кГц. NB означает узкую полосу частот
