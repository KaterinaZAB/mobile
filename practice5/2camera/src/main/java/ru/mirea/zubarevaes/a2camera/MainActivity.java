package ru.mirea.zubarevaes.a2camera;


import ru.mirea.zubarevaes.a2camera.databinding.ActivityMainBinding;
...
import ru.mirea.zubarevaes.a2camera.databinding.ActivityMainBinding;
// на телефоне приложение files - sdk - android - data - ru - files - pictures
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int	storagePermissionStatus = ContextCompat.checkSelfPermission(this,
                android.Manifest.permission.WRITE_EXTERNAL_STORAGE);//для записи во внешнее хранилище
